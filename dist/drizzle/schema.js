...
exports.usersTable = (0, pg_core_1.pgTable)("users", {
    ...
    password: (0, pg_core_1.varchar)("password", { length: 256 }).unique(),
});
//AUTH_user table
...
// auth relations
exports.authUserRelations = (0, drizzle_orm_2.relations)(exports.authUsers, ({ one }) => ({
    user: one(exports.usersTable, {
        fields: [exports.authUsers.userId],
